...
Lo probe en UVA 1449 y https://codeforces.com/gym/106636/problem/A
...
// Halla el siguiente elemento que pertenece a un patron 
	if(states[act].pattern==-1){ const int nxt=link(act);
